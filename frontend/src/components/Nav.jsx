...
const Nav = () => {
  return (
    <div className=' fixed bg-transparent top-0 -z-5 left-0 w-full min-h-[10vh] flex justify-center items-center'>
        <ul className='flex justify-around items-center gap-8 text-2xl text-white  '>
